...
<p> Hi! I'm a 22-year-old Computer Science graduate working as a DevOps Engineer. With experience in gamified web development, I'm now fully focused on honing my skills and growing in the DevSecOps field. In my spare time, I enjoy diving into physics and astronomy. 💖🔭
</p>
...
<div>
    <p align="center">
      <img src="https://skillicons.dev/icons?i=styledcomponents,python,js,html,css,nodejs,react,nextjs,vite,threejs,aws,bitbucket,bash,githubactions,git,webpack,jenkins,docker,kubernetes,heroku,vercel,alpinejs,tailwind,figma,flutter,prisma,cypress,linux,vim,nginx" />
    </p>
</div>
